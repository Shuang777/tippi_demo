...
LIBS += /home/shuang/softwares/portaudio/lib/.libs/libportaudio.so /home/shuang/softwares/libsndfile-1.0.25/src/.libs/libsndfile.so
...
LIBS += -lrt -lasound -lpthread -lm -lfst -llapack -lcblas -latlas -lf77blas -ldl
